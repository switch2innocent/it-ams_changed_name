...
<body>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Scrap</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        ...
                        <table id="desktop_pc" class="ui celled table pb-20 table-responsive" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $view_scrap = new Assets($db);

                                $view = $view_scrap->view_scraps();
    ...
    <!-- Custom JS -->
    <script src="assets/js/scrap.script.js"></script>
</body>
