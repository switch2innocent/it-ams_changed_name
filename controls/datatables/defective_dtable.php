...
OR itamsdb.it_asset_tbl.stat_id = 3)';
...
//Fetch data
$view = $view_asset->view_defectives($sql);
$data = [];
...
//Total records
$total_all_rows = $view_asset->view_defectives(str_replace("LIMIT $start, $length", "", $sql))->rowCount();
