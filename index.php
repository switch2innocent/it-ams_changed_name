		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7 d-flex justify-content-center">
					<img src="vendors/images/custompic2.png" alt="" style="max-width: 75%; height: auto;">
				</div>
					...
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form>
							<div class="input-group custom">
								<input type="text" class="form-control form-control-lg" id="username_email" placeholder="Username / Email">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										<a class="btn btn-primary btn-lg btn-block" href="#" id="sign_in">Sign In</a>
									</div>
								</div>
							</div>
						</form>
