            ...
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        ...
                        <table id="printer" class="ui celled table pb-20 table-responsive" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Barcode</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="form_type" id="form_type" value="Printer">
