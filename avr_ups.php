            ...
            <div class="min-height-200px">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">AVR UPS</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        ...
                        <table id="avr_ups" class="ui celled table pb-20 table-responsive" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Barcode</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="form_type" id="form_type" value="AVR UPS">
